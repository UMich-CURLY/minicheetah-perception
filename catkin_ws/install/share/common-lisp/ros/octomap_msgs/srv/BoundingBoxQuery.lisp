...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BoundingBoxQuery-request>)))
  ...
  (cl:format cl:nil "# Clear a region specified by a global axis-aligned bounding box in stored OctoMap~%~%# minimum corner point of axis-aligned bounding box in global frame~%geometry_msgs/Point min~%# maximum corner point of axis-aligned bounding box in global frame~%geometry_msgs/Point max~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BoundingBoxQuery-request)))
  "Returns full string definition for message of type 'BoundingBoxQuery-request"
  (cl:format cl:nil "# Clear a region specified by a global axis-aligned bounding box in stored OctoMap~%~%# minimum corner point of axis-aligned bounding box in global frame~%geometry_msgs/Point min~%# maximum corner point of axis-aligned bounding box in global frame~%geometry_msgs/Point max~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
